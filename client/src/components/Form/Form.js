    ...
    return (
        <Paper className={classes.paper}>
            <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <Button className={classes.buttonSubmit} type="submit"  variant="contained" color="primary" size="large" fullWidth>ZAPISZ</Button>
                <Button className={classes.searchButton} variant="contained" color="secondary" onClick={clear} fullWidth >Wyczyść</Button>
            </form>
        </Paper>
    );
}
